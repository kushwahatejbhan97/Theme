...
function doCCC3(nam, nam2, nnn){
	var limit=255;
	if(nnn!='')limit=nnn;

	if(document.getElementById(nam2).value.length>limit)document.getElementById(nam2).value = document.getElementById(nam2).value.substring(0, limit);
	document.getElementById(nam).innerHTML = limit-document.getElementById(nam2).value.length;
}
